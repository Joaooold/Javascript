...
// Mais metodos Map,filter,reduce
// metodo Map()
const listaDeFaturamentos = [
  20_000, 25_000, 30_000, 40_000, 35_000, 27_000, 50_000, 47_000, 22_000, 32_000, 40_000, 45_000,
];

const faturamentoEmReais = listaDeFaturamentos.map((valorFaturamentoEmReais) => 5.22 * valorFaturamentoEmReais);

console.log(faturamentoEmReais);

// Metodo filter()

const metaDefaturamento = listaDeFaturamentos.filter((metaFaturamentoAtingida) => metaFaturamentoAtingida >= 40_000);
