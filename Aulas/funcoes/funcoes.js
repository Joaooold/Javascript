...
function trabalhadores(nome, profissao) {
    console.log(`O trabalhador: ${nome} e seu trabalho: ${profissao}`)
}
trabalhadores("João", "Engenheiro")
trabalhadores("Lucelia", "Tutora")
trabalhadores("Luiza", "Fisioterapeuta")
trabalhadores("Lucas", "Grendene")
